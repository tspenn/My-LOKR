-- The public sample LOKR is a real locker owned by fred@skylandapps.com.
-- Apply this in the LOKR Supabase SQL editor. It only changes that locker:
-- unlimited people and live video, so the sample works like the full product.
-- Private lockers keep their plan limits.
