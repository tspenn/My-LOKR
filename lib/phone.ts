...
export function inviteEmailCodeText(code: string) {
  return `Your LOKR code is ${code}. Enter it on the join page. It only works from the email this invite was sent to.`;
}
