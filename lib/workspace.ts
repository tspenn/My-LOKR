...
import { isSampleLockerEmail } from "@/lib/sample-locker";
...
export async function getCurrentWorkspace() {
  ...
  return {
    ...
    lockrCount,
    sample: isSampleLockerEmail(owner?.email),
  };
}

export function workspaceUsage(workspace: Workspace, sample = false) {
  ...
  return {
    ...
    maxUsers: sample ? null : PLANS[plan].maxUsers,
  };
}
