/** Operator terms for My Lokr. Not a substitute for a lawyer’s review. */
...
export const TERMS = {
  ...
  intro:
    "My Lokr is a private messaging and file space run by Skyland. These terms protect the people who use it in good faith, and they protect Skyland from people who would use it to harm others or break the law. By creating an account or using My Lokr, you agree to them.",
  sections: [
    {
      title: "Your account",
    ...
    },
    {
      ...
      body: "My Lokr is provided as-is. We work to keep it locked and running, but we do not promise it will always be available, or that other users will behave. To the fullest extent the law allows, Skyland is not liable for what users post, for lost files, or for damages beyond the amount you paid us in the 12 months before a claim (or $0 if you are on Free). Some places do not allow these limits. In those places, they apply only as far as they can.",
    },
    {
